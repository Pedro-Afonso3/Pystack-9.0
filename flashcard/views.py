    ...
    if request.method == 'GET':
        ...
        return render(request, 'novo_flashcard.html', {'categorias': categorias, 'dificuldades': dificuldades, 
         ...
         if len(pergunta.strip()) == 0 or len(resposta.strip()) == 0:
            messages.add_message(request, constants.ERROR, 'Preencha os campos de perguntas e resposta')
...
def listar_desafio(request):
    ...
    '''if request.method == 'GET':
        ...
        return render(request, 'listar_desafio.html', {'categorias': categorias, 'dificuldades': dificuldades, })
